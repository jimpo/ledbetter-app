...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "statement", "symbols": [{"literal":"SET"}, "__", {"literal":"PIXELS_PER_METER"}, "__", "float", "_", (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": (t) => {return { statement: "set_pixels_per_meter", value: t[4] }}},
    {"name": "statement", "symbols": [{"literal":"STRIP"}, "__", {"literal":"AT"}, "__", "float", {"literal":"m"}, "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "float", {"literal":"m"}, "_", (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": (t) => {return { statement: "strip", x: t[4], y: t[9] }}},
    {"name": "statement", "symbols": [{"literal":"TURN"}, "__", "float", "__", {"literal":"degrees"}, "_", (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": (t) => {return { statement: "turn", degrees: t[2] }}},
    ...
    {"name": "float", "symbols": [(lexer.has("int") ? {type: "int"} : int)], "postprocess": (t) => parseFloat(t[0])},
